...
{
    [Activity (Label = "Eddie - OpenVPN GUI", Icon = "@drawable/icon", Theme="@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
    public class MainActivity : AppCompatActivity
	{
        ...
        private void SelectOpenVPNProfile(Uri profile)
        {
            ...
            if(profileInfo != null)
            {
                ...
                else if(profileInfo["status"].Equals("not_found"))
                {
                    supportTools.InfoDialog(Resource.String.conn_profile_not_found);
                }
                else if(profileInfo["status"].Equals("invalid"))
                {
                    supportTools.InfoDialog(Resource.String.conn_profile_is_invalid);
                }
                else if(profileInfo["status"].Equals("no_permission"))
                {
                    supportTools.InfoDialog(Resource.String.conn_profile_no_permission);
                }
            }
        }
        ...
        private void SaveCurrentProfile()
        {
            ...
            if(profileData.Equals("") || profileInfo == null)
                return;
