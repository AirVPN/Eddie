...
namespace Eddie.Core
{
	...
	public static class Messages
	{
		...
		public static string ReportStepCollectEnvironmentInfo = "Collect environment information..."; // TOTRANSLATE
		public static string ReportStepTests = "Perform tests..."; // TOTRANSLATE
		public static string ReportStepLogs = "Collect logs..."; // TOTRANSLATE
		public static string ReportStepNetwork = "Collect Network information..."; // TOTRANSLATE
		public static string ReportStepPlatform = "Collect platform-specific information..."; // TOTRANSLATE
		public static string ReportStepDone = "Report completed"; // TOTRANSLATE
		public static string ReportLogs = "Logs"; // TOTRANSLATE
		public static string ReportOptions = "Important options not at defaults"; // TOTRANSLATE
		...
		public static string RouteAddFailed = "Routes, add {1} for gateway {2} failed: {3}"; // TOTRANSLATE
		public static string RouteDelFailed = "Routes, remove {1} for gateway {2} failed: {3}"; // TOTRANSLATE
		public static string RouteAddRemoved = "Routes, restored a previously deleted route, {1} for gateway {2}"; // TOTRANSLATE
		public static string RouteAddNew = "Routes, added a new route, {1} for gateway {2}"; // TOTRANSLATE
		public static string RouteDelAdded = "Routes, removed a route previously added, {1} for gateway {2}"; // TOTRANSLATE
		public static string RouteDelExist = "Routes, removed an existing route, {1} for gateway {2}"; // TOTRANSLATE
		...
		public static string TorControlMeekUnsupported = "Tor, meek bridge found, unsupported yet. Please remove it from the config"; // TOTRANSLATE
		...
		public static string IPv6NotSupportedByOS = "Detected IPv6 disabled at OS level. You need to re-enable it manually (require reboot) or disable this warning by setting Preferences > Networking > Layer IPv6: Block.";
		...
		public static string WindowsSettingsSomeProtocolsUnavailable = "{1} protocol modes not available due your OpenVPN version."; // TOTRANSLATE
		...
		public static string WindowsProviderEditOpenVPNSupportIPv6 = " (unfortunately, can't be detected a priori)"; // TOTRANSLATE
		...
		public static string ManHeaderComment = "Generated with 'airvpn -cli -help -help.format=man'";
