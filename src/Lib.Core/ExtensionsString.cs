...
namespace Eddie.Core
{
	public static class ExtensionsString
	{
		...
		// Used in dump/report, try to remove ininfluent data
		public static string PruneForReport(this string str)
		{
			string result = str;
			result = result.RegExReplace("[a-zA-Z0-9+/]{30,}=", "{base64-omissis}");
			return result;
		}
