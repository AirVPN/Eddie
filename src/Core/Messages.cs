...
namespace AirVPN.Core
{
    public static class Messages
    {
		...
		public static string ConsoleKeyboardHelp = "Press 'C' to Cancel, 'N' to switch to next server.";
		...
		public static string AdminRequiredStop = "You need root access for this program (to create network tunnel)";
