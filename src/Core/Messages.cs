...
namespace Eddie.Core
{
    ...
    public static class Messages
    {
		...
		public static string ConnectionCheckingRouteFailed = "Checking route failed.";
		...
		public static string WindowsSettingsProtocolRouteOut = "Outside tunnel";
		public static string WindowsSettingsProtocolRouteBlock = "Block";
