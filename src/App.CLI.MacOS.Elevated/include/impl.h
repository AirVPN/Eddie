...
#include "../../Lib.CLI.Elevated/include/ibsd.h"
...
private:
	...
	std::string WorkaroundDnsLookupIPv6Enable(const std::string& iface);
	std::string WorkaroundDnsLookupIPv6Disable(const std::string& iface);
};
