...
###g++ -mmacosx-version-min=10.9 -shared -install_name @rpath/libLib.Platform.MacOS.Native.dylib -fPIC -o "$BASEPATH/bin/libLib.Platform.MacOS.Native.dylib" "$BASEPATH/lib.cpp" -Wall -std=c++11 -lcurl -O3 -D$1
...
g++ -dynamiclib -framework CoreFoundation -framework Security -mmacosx-version-min=10.9 -shared -install_name @rpath/libLib.Platform.MacOS.Native.dylib -fPIC -o "$BASEPATH/bin/libLib.Platform.MacOS.Native.dylib" "$BASEPATH/lib.cpp" -Wall -std=c++11 -lcurl -O3 -D$1
