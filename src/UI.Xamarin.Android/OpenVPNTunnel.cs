...
namespace Eddie.Droid
{
	...
	{
		private AndroidVPNService m_service = null;
		...
		private Stack<AndroidVPNContext> m_contexts = new Stack<AndroidVPNContext>();
		...
		public AndroidVPNService Service
		{
			get
			{
				return m_service;
		...
		public AndroidVPNContext ActiveContext
		{
			get
			{
				lock(m_contextsSync)
				{
					AndroidVPNContext context = null;
		...
		private int OnTunBuilderNewImpl()
		{
			lock(m_contextsSync)
			{
				m_contexts.Push(new AndroidVPNContext(Service));
			}
		...
		private int OnTunBuilderSetBlockIPV6(/*bool*/ int block_ipv6)
		{
			...
			try
			{
				ActiveContext.SetBlockIPV6(Utils.BoolCast(block_ipv6));
		...
		public void BindOptions()
		{
			lock(m_clientSync)
			{
				...
				DoSetOption(OptionsManager.OVPN3_OPTION_TLS_VERSION_MIN_NATIVE, OptionsManager.Ovpn3TLSVersionMin);
				DoSetOption(OptionsManager.OVPN3_OPTION_PROTOCOL_NATIVE, OptionsManager.Ovpn3Protocol);
				DoSetOption(OptionsManager.OVPN3_OPTION_IPV6_NATIVE, OptionsManager.Ovpn3IPV6);
				DoSetOption(OptionsManager.OVPN3_OPTION_TIMEOUT_NATIVE, OptionsManager.Ovpn3Timeout);
				DoSetOption(OptionsManager.OVPN3_OPTION_TUN_PERSIST_NATIVE, ToOptionValue(OptionsManager.Ovpn3TunPersist));
				DoSetOption(OptionsManager.OVPN3_OPTION_COMPRESSION_MODE_NATIVE, OptionsManager.Ovpn3CompressionMode);
				DoSetOption(OptionsManager.OVPN3_OPTION_USERNAME_NATIVE, OptionsManager.Ovpn3Username);
				DoSetOption(OptionsManager.OVPN3_OPTION_PASSWORD_NATIVE, OptionsManager.Ovpn3Password);
				DoSetOption(OptionsManager.OVPN3_OPTION_SYNCHRONOUS_DNS_LOOKUP_NATIVE, ToOptionValue(OptionsManager.Ovpn3SynchronousDNSLookup));
				DoSetOption(OptionsManager.OVPN3_OPTION_AUTOLOGIN_SESSIONS_NATIVE, ToOptionValue(OptionsManager.Ovpn3AutologinSessions));
				DoSetOption(OptionsManager.OVPN3_OPTION_DISABLE_CLIENT_CERT_NATIVE, ToOptionValue(OptionsManager.Ovpn3DisableClientCert));
				DoSetOption(OptionsManager.OVPN3_OPTION_SSL_DEBUG_LEVEL_NATIVE, OptionsManager.Ovpn3SSLDebugLevel);
				DoSetOption(OptionsManager.OVPN3_OPTION_PRIVATE_KEY_PASSWORD_NATIVE, OptionsManager.Ovpn3PrivateKeyPassword);
				DoSetOption(OptionsManager.OVPN3_OPTION_DEFAULT_KEY_DIRECTION_NATIVE, OptionsManager.Ovpn3DefaultKeyDirection);
				DoSetOption(OptionsManager.OVPN3_OPTION_FORCE_AES_CBC_CIPHERSUITES_NATIVE, ToOptionValue(OptionsManager.Ovpn3ForceAESCBCCiphersuites));
				DoSetOption(OptionsManager.OVPN3_OPTION_TLS_CERT_PROFILE_NATIVE, OptionsManager.Ovpn3TLSCertProfile);
				if(OptionsManager.SystemProxyEnable)
				{
					DoSetOption(OptionsManager.OVPN3_OPTION_PROXY_HOST_NATIVE, OptionsManager.Ovpn3ProxyHost);
					DoSetOption(OptionsManager.OVPN3_OPTION_PROXY_PORT_NATIVE, OptionsManager.Ovpn3ProxyPort);
					DoSetOption(OptionsManager.OVPN3_OPTION_PROXY_USERNAME_NATIVE, OptionsManager.Ovpn3ProxyUsername);
					DoSetOption(OptionsManager.OVPN3_OPTION_PROXY_PASSWORD_NATIVE, OptionsManager.Ovpn3ProxyPassword);
					DoSetOption(OptionsManager.OVPN3_OPTION_PROXY_ALLOW_CLEARTEXT_AUTH_NATIVE, ToOptionValue(OptionsManager.Ovpn3ProxyAllowCleartextAuth));
				}				
			}
		}
		...
		private void ClearContexts()
		{
			...
			lock(m_contextsSync)
			{
				while(m_contexts.Count > 0)
				{
					...
					Utils.SafeDispose(m_contexts.Pop());
				}
			}			
		}
	}
