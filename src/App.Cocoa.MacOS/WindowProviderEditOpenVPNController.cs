...
namespace Eddie.UI.Cocoa.Osx
{
	public partial class WindowProviderEditOpenVPNController : AppKit.NSWindowController
	{
		...
		public override void AwakeFromNib()
		{
			...
			Window.Title = Constants.Name + " - " + LanguageManager.GetText(LanguageItems.WindowsProviderEditOpenVPNTitle);
			...
			ChkSupportIPv6.Title = LanguageManager.GetText(LanguageItems.WindowsProviderEditOpenVPNSupportIPv6);
