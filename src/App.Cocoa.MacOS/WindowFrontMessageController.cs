...
namespace Eddie.UI.Cocoa.Osx
{
	public partial class WindowFrontMessageController : AppKit.NSWindowController
	{
		...
		public override void AwakeFromNib()
		{
			...
			Window.Title = Constants.Name + " - " + LanguageManager.GetText(LanguageItems.WindowsFrontMessageTitle);

			GuiUtils.SetButtonDefault(Window, CmdClose);

            TxtMessage.StringValue = Message["text"].Value as string;
			CmdClose.Title = LanguageManager.GetText(LanguageItems.WindowsFrontMessageAccept);			
