...
{
    public partial class WindowProviderEditWireGuardController : AppKit.NSWindowController
	{
		...
		public WindowProviderEditWireGuardController(IntPtr handle) : base(handle)
		{
			Initialize();
		}
		...
		public WindowProviderEditWireGuardController(NSCoder coder) : base(coder)
		{
			Initialize();
		}

		// Call to load from the XIB/NIB file
		public WindowProviderEditWireGuardController() : base("WindowProviderEditWireGuard")
		{
			Initialize();
		}
		...
		public new WindowProviderEditWireGuard Window
		{
			get
			{
				return (WindowProviderEditWireGuard)base.Window;
			}
		}
		...
		public override void AwakeFromNib()
		{
			...
			Window.Title = Constants.Name + " - " + LanguageManager.GetText(LanguageItems.WindowsProviderEditWireGuardTitle);
			...
			ChkSupportIPv6.Title = LanguageManager.GetText(LanguageItems.WindowsProviderEditWireGuardSupportIPv6);
