...
rem temp call windows_portable\build.bat cli x64 windows-10 || goto :error
...
rem temp call windows_portable\build.bat cli x86 windows-10 || goto :error
...
call windows_portable\build.net5.bat ui x64 windows-10 || goto :error
