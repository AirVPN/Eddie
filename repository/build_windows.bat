...
call windows_portable\build.bat cli x64 windows || goto :error
...
call windows_portable\build.bat cli x86 windows || goto :error
...
call windows_portable\build.bat ui x64 windows || goto :error
