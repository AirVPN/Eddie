...
call windows_installer\build.bat cli x64 windows-10 || goto :error
call windows_installer\build.bat cli x64 windows-7 || goto :error
call windows_installer\build.bat cli x64 windows-vista || goto :error
call windows_installer\build.bat cli x64 windows-xp || goto :error
call windows_installer\build.bat cli x86 windows-10 || goto :error
call windows_installer\build.bat cli x86 windows-7 || goto :error
call windows_installer\build.bat cli x86 windows-vista || goto :error
call windows_installer\build.bat cli x86 windows-xp || goto :error
