...
linux_portable/build.sh cli net7
linux_appimage/build.sh cli net7
linux_debian/build.sh cli net7
linux_rpm/build.sh cli net7 opensuse
linux_rpm/build.sh cli net7 fedora
